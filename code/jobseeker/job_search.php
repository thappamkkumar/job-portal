...
<div class="main_container">
					...
					<div class="container">
							...
							<div class="sub_container">
									...
									<a href="jobseeker.php" style=" float:right; margin-right:20px;  background:#fff; color:rgba(34,98,198,1); text-decoration:none; padding-left:5px; padding-right:5px; font-size:30px; font-weight:bold;">&times;</a>
										<h1> Result of your search</h1>						
												...
												<div class="job_container" id="job_container_id">
													<?php
															$result_per_page=10;
															 if(isset($_POST['search']))
															  ...
															  $job_title=$_POST["job_title"];
																...
																if($company_name=="")
																{
																	$result_query = mysqli_query($con,"Select * from jobs Where Job_Title='$job_title' ");  
															
																}
																else if($job_title=="")
																{
																	$result_query= mysqli_query($con,"Select * from jobs Where  Company_Name='$company_name' ");  
																
																}
																else{
																$result_query = mysqli_query($con,"Select * from jobs Where Job_Title='$job_title' AND Company_Name='$company_name' ");  
																}
															...
															$page_first_result=($page-1)*$result_per_page;
																...
																if($company_name=="")
																{
																	$result = mysqli_query($con,"Select * from jobs Where Job_Title='$job_title' LIMIT ".$page_first_result.','.$result_per_page);
															
																}
																else if($job_title=="")
																{
																	$result = mysqli_query($con,"Select * from jobs Where  Company_Name='$company_name' LIMIT ".$page_first_result.','.$result_per_page);
																
																}
																else{
																$result = mysqli_query($con,"Select * from jobs Where Job_Title='$job_title' AND Company_Name='$company_name' LIMIT ".$page_first_result.','.$result_per_page); 
																}
												...
												<div class="page_number_container">
														...
														<?php
														 ...
														 if($page>1)
														 {
															echo'<a href="job_search.php? page='.($page-1).' " class="page_number">Prev</a>';
														 }
														 if($page<$number_of_page)
															echo'<a href="job_search.php? page='.($page+1).' " class="page_number">Next</a>';
