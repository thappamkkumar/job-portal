...
<div class="main_container">
					...
					<div class="container">
							...
							<a href="about_page.php" id="about">About</a>
							</div>
									<div class="content">
											...
											<input type="text" class="input1" value="<?php echo$row['Page2_Title'];?>" name="title">
											
											<lable>Page Description</lable>
											<textarea   rows="5" class="input1" name="description"><?php echo$row['Page2_Description'];?></textarea>
					...
					if(mysqli_query($con, $sql))
						{
								...
								echo "<script> alert('About Page is update successfully') ; </script>"; 
								
						}	
					else
					{
						echo "<script> alert('Enable to update about page : try again') ; </script>"; 
...
?>
<script>
document.getElementById("about").style.background="#fff";
		document.getElementById("about").style.color="rgba(0,0,200,1)";
