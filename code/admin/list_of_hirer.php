							...
							<div class="sub_container">
								<div class="jobseeker_container">
												...
												<div class="content_container">
														<table>
														<tr><th>S.NO.</th><th>COMPANY NAME</th><th>CONCERN NAME</th><th>EMAIL</th><th>REGISTRATION DATE</th><th>ACTION</th></tr>
																				...
																				$result_per_page=10;
																					if(isset($_POST['search']))
																										{	
																											...
																											$result_query=mysqli_query($con,"Select * from employers WHERE Email='$search_value'"); 
																						...
																						$page_first_result=($page-1)*$result_per_page;
																						 ...
																						 if(isset($_POST['search']))
																										{	
																											echo"<a href='list_of_hirer.php' style='background:rgba(34,98,198,0.5);    color:rgba(255,255,255,1); text-decoration:none; display:block; width:90%; height:30px; margin:auto; font-size:25px; font-weight:bold;'>	<span style='display:inline-block; width:20px; '></span>&times;</a>";
																										   $search_value=$_POST['search_value'];
																											$result2 = mysqli_query($con,"Select * from employers WHERE Email='$search_value' LIMIT ".$page_first_result.','.$result_per_page); 
																							
																										}
																										else{
																							$result2 = mysqli_query($con,"Select * from employers LIMIT ".$page_first_result.','.$result_per_page); 
																										}
														...
														<td>
															<form  action="hirer_profile.php"  method="post" style=" display:inline;">
												...
												<div class="page_container">
														<?php
														 ...
														 if($page>1)
														 {
															echo'<a href="list_of_hirer.php? page='.($page-1).' " class="page_number">Prev</a>';
														 }
														 if($page<$number_of_page)
															echo'<a href="list_of_hirer.php? page='.($page+1).' " class="page_number">Next</a>';
...
document.getElementById("list_of_hirer").style.borderLeft="5px solid rgba(255,255,255,1)";
		document.getElementById("icon_list_of_hirer").style.background="rgba(255,255,255,0.5)";
