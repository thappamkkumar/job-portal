									...
									?>
													...
													<div class="candidate_container">
																...
																<?php
																				...
																				$search_value=$_POST['search_value'];
																					$result_query= mysqli_query($con,"Select * from jobs_applied WHERE Employer_ID='$value_1' AND Job_Title='$search_value' " );   
																				}			
																					else
																					{
																						...
																						if(isset($_POST['search']))
																					{	
																				echo"<div class='sub_container_heading'>
																				<a href='candidate_list.php' style='background:#fff; float:right; margin-right:20px;  color:rgba(34,98,198,1); text-decoration:none; padding-left:5px; padding-right:5px; font-size:30px; font-weight:bold; '>&times;</a>
																				<h1> Hirer | List of Candidates</h1></div>";
																						echo"";
																						   $search_value=$_POST['search_value'];
																							$result = mysqli_query($con,"Select * from jobs_applied WHERE Employer_ID='$value_1' AND Job_Title='$search_value' LIMIT ".$page_first_result.','.$result_per_page);   
																					}	
																					else{
											...
											<div class="page_number_container">
														...
														<?php
														 ...
														 if($page>1)
														 {
															echo'<a href="search_candidate.php? page='.($page-1).' " class="page_number">Prev</a>';
														 }
														 if($page<$number_of_page)
															echo'<a href="search_candidate.php? page='.($page+1).' " class="page_number">Next</a>';
