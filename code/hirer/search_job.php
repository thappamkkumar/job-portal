													...
													<?php
															...
															if(isset($_POST['search']))
																...
																$search_value=$_POST['search_value'];
																  $result_query= mysqli_query($con,"Select * from jobs WHERE Employer_ID='$value_1' AND Job_Title='$search_value'  ");  
																}
																else{
															...
															if(isset($_POST['search']))
																...
																<a href='job_list.php' style='display:inline-block;  background:#fff; color:rgba(34,98,198,1); text-decoration:none; padding-left:5px; padding-right:5px; font-size:25px; float:right; margin-right:20px; '>&times;</a>
																<h1> Hirer | List of Jobs</h1></div>";
																
																$search_value=$_POST['search_value'];
																  $result = mysqli_query($con,"Select * from jobs WHERE Employer_ID='$value_1' AND Job_Title='$search_value'  LIMIT ".$page_first_result.','.$result_per_page);  
																}
														else{
																	...
																	<div class="job" id="id_job" >
																						...
																						<div  class="job_detail_container">
																										<form  action="job_detail.php"  id="GFG" method="post" style=" display:inline;">
																												...
																												<img src="../image/location3.png"  style="width:20px;height:20px;" class="icon_imagess"> <span style="margin-left:10px;" ><?php echo$row['Job_Location'];?></span>
